...
class LikesServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLikes = channel.unary_unary(
                '/hipstershop.LikesService/GetLikes',
                request_serializer=demo__pb2.GetLikesRequest.SerializeToString,
                response_deserializer=demo__pb2.GetLikesResponse.FromString,
                _registered_method=True)
        self.AddLike = channel.unary_unary(
                '/hipstershop.LikesService/AddLike',
                request_serializer=demo__pb2.AddLikeRequest.SerializeToString,
                response_deserializer=demo__pb2.AddLikeResponse.FromString,
                _registered_method=True)
...
def add_LikesServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetLikes': grpc.unary_unary_rpc_method_handler(
                    servicer.GetLikes,
                    request_deserializer=demo__pb2.GetLikesRequest.FromString,
                    response_serializer=demo__pb2.GetLikesResponse.SerializeToString,
            ),
            'AddLike': grpc.unary_unary_rpc_method_handler(
                    servicer.AddLike,
                    request_deserializer=demo__pb2.AddLikeRequest.FromString,
                    response_serializer=demo__pb2.AddLikeResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.LikesService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('hipstershop.LikesService', rpc_method_handlers)
...
class LikesService(object):
    ...
    def GetLikes(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.LikesService/GetLikes',
            demo__pb2.GetLikesRequest.SerializeToString,
            demo__pb2.GetLikesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def AddLike(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.LikesService/AddLike',
            demo__pb2.AddLikeRequest.SerializeToString,
            demo__pb2.AddLikeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
